...
public class CakeOrderDb {
    ...
    String cake_code,cake_name,cake_msg_print,cake_quantity,cake_date,cake_price,cake_add,cake_status;

    public CakeOrderDb(String cake_code, String cake_name, String cake_msg_print, String cake_quantity, String cake_date, String cake_price, String cake_add, String cake_status) {
